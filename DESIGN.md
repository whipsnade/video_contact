...
- Heart/wishlist button overlay on images
...
8. Prefer whitespace over borders when defining sections
9. Keep the interface warm, tactile, and lightly editorial
10. Use color sparingly outside the brand red
